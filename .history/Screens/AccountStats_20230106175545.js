  ...
  const unfollowUser = async (item) => {
    ...
    try {
      await updateDoc(doc(firestore, "users", item.id), {
        ...
        const selectedUserDocRef = doc(firestore, "users", item.id);
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        >
          <Tab.Screen name="Abonnés" component={FollowersRoute} />
          <Tab.Screen name="Abonnements" component={FollowingRoute} />
        </Tab.Navigator>
      </View>
    </View>
  );
