...
const Feed = ({ route, navigation }) => {
  ...
  const getElapsedTime = (time) => {
    ...
    switch (secondsElapsed) {
      case secondsElapsed > 0 && secondsElapsed < 60:
        return "Il y'a " + secondsElapsed + " secondes";

      case secondsElapsed >= 60 && secondsElapsed < 3600:
        return "Il y'a " + secondsElapsed + " minutes";

      default:
        return "Il y'a " + secondsElapsed + " jours";
    }
  };
