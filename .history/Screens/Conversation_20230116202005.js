    ...
    return (
      <View
        style={{
          ...
          alignItems: "center",
          borderRadius: 10,
          marginEnd: item.sender === auth.currentUser.uid ? 5 : 0,
      ...
      >
        ...
        <Text style={{ fontSize: 14, color: "#A7A7A7" }}>{item.createdAt}</Text>
      </View>
    );
  };
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        >
          <FlatList
            contentContainerStyle={{ marginTop: 25, marginBottom: 25 }}
